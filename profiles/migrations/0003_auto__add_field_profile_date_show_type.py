...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.date_show_type'
        db.add_column('profiles_profile', 'date_show_type',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.date_show_type'
        db.delete_column('profiles_profile', 'date_show_type')
