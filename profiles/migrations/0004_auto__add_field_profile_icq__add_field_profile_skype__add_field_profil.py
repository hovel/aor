...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'icq',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.skype'
        db.add_column('profiles_profile', 'skype',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.jabber'
        db.add_column('profiles_profile', 'jabber',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.site'
        db.add_column('profiles_profile', 'site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.interests'
        db.add_column('profiles_profile', 'interests',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profiles_profile', 'icq')

        # Deleting field 'Profile.skype'
        db.delete_column('profiles_profile', 'skype')

        # Deleting field 'Profile.jabber'
        db.delete_column('profiles_profile', 'jabber')

        # Deleting field 'Profile.site'
        db.delete_column('profiles_profile', 'site')

        # Deleting field 'Profile.interests'
        db.delete_column('profiles_profile', 'interests')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'date_show_type': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
