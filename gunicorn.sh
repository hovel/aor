...
# -----------------------------------------------------------------------------
# *** change these paths ***
VIRTUAL_ACTIVATE=/home/zeus/.virtualenvs/archlinux/bin/activate
SITE_INSTANCE=/home/zeus/archlinux
# -----------------------------------------------------------------------------

CONFIG_FILE=/home/zeus/archlinux/conf/gunicorn.conf.py
LOG_FILE=/home/zeus/logs/archlinux-error.log
PID_FILE=/home/zeus/archlinux/wsgi.pid
CALL_INFO="$0 $*"
